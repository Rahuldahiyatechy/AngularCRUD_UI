...
export class TFRgridService {
  constructor(
    // private tfrHelper: TfrHelper,
    //private tfrConstants: TfrConstants
  ) {
  }
  ...
  getActionsColumn = (idValue: number | string, canEdit: boolean, canDelete: boolean, canDuplicate = false) => {
